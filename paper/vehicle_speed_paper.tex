...
\bibitem{llorca2021survey}
D. Fern\'andez Llorca, A. Hern\'andez Mart\'inez, and I. Garc\'ia Daza,
``Vision-Based Vehicle Speed Estimation: A Survey,''
\textit{arXiv preprint arXiv:2101.06159}, 2021.
...
\bibitem{macko2025efficient}
A. Macko, L. Gajdo\v{s}ech, and V. Kocur,
``Efficient Vision-Based Vehicle Speed Estimation,''
\textit{arXiv preprint arXiv:2505.01203}, 2025.

\bibitem{uhrig2017depth}
J. Uhrig, N. Schneider, L. Schneider, U. Franke, T. Brox, and A. Geiger,
``Sparsity Invariant CNNs,''
\textit{IEEE International Conference on 3D Vision (3DV)}, 2017.
